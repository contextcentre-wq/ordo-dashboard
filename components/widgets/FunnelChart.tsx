...
const FunnelChart: React.FC<FunnelChartProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm h-full w-fit flex flex-col">
      <h3 className="text-gray-500 font-medium mb-4 text-sm">Воронка</h3>

      <div className="flex-1 min-h-0">
        <svg width={svgWidth} height="100%" viewBox={`0 0 ${svgWidth} ${height}`} preserveAspectRatio="xMidYMax meet">
